...
Product.create!(title: 'Docker for Rails Developers',
  ...
  image_url: 'https://media.pragprog.com/titles/rails7/code/rails7/depot_a/app/assets/images/ridocker.jpg',
  price: 19.95)
# . . .
Product.create!(title: 'Design and Build Great Web APIs',
  ...
  image_url: 'https://media.pragprog.com/titles/rails7/code/rails7/depot_a/app/assets/images/maapis.jpg',
  price: 24.95)
# . . .
...
Product.create!(title: 'Modern CSS with Tailwind',
  ...
  image_url: 'https://media.pragprog.com/titles/rails7/code/rails7/depot_a/app/assets/images/tailwind.jpg',
  price: 18.95)
